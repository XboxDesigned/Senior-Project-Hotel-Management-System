...
<body>
            ...
            <tbody>
                ...
                if (!isset($error)) {
                    ...
                    if (!empty($search_term)) {
                        $query .= " AND (r.confirmation_num LIKE :search 
                    ...
                    if (!$statement) {
                        ...
                        if (empty($result)) {
                            echo "<tr><td colspan='10'>No checked-in guests found" . (!empty($search_term) ? " matching '$search_term'" : "") . ".</td></tr>";
                        } else {
    ...
    if (isset($_POST['back_to_list']) || isset($_POST['close_modal'])) {
        echo "<meta http-equiv='refresh' content='0;url=in_house.php?search=" . urlencode($search_term) . "'>";
    }
    ?>
</body>
</html>